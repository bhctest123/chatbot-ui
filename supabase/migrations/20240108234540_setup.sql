...
AS $$
DECLARE
  project_url TEXT := 'https://iigdafpbpyfjruayiktu.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlpZ2RhZnBicHlmanJ1YXlpa3R1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjUwMTU4NCwiZXhwIjoyMDIyMDc3NTg0fQ.traSrzqjPmuVzmWlxDyRHG0CEhpaRZWbZ1GZZ7t1Tk4'; -- full access needed for http request to storage
